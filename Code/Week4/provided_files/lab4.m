...
figure;
plot_camera(P1,w,h, 'r');
plot_camera(Pc2{1},w,h, 'b');
plot_camera(Pc2{2},w,h, 'b');
plot_camera(Pc2{3},w,h, 'b');
...
[disparity_ssd] = stereo_computation(double(left_image), double(right_image), ... 
